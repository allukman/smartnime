...
class TopAnimeAdapter(private val items: ArrayList<TopAnimeModel>): RecyclerView.Adapter<TopAnimeAdapter.TopAnimeHolder>() {
    ...
    class TopAnimeHolder(val binding: ItemListAnimeBinding): RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TopAnimeHolder {
        return TopAnimeHolder(
